...
const Footer = async () => {
    const repoStats = await fetch(
        'https://api.github.com/repos/adarshsahu460/My-portfolio',
        {
            next: {
    ...
    return (
        <footer className="text-center pb-5" id="contact">
            <div className="container">
                ...
                <div className="">
                    <a
                        href="https://github.com/adarshsahu460/My-portfolio"
                        target="_blank"
                        className="leading-none text-muted-foreground hover:underline hover:text-white"
                    >
                        Design & built by Adarsh Sahu
